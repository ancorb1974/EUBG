...
//Produced on Thu Jun 16 22:52:43 2016 : Created on Thu Jun 16 22:52:43 2016
//http://dev-heaven.net/projects/list_files/mikero-pbodll
////////////////////////////////////////////////////////////////////

#define _ARMA_

//Class EUBG_Main : Weapons\config.bin{
class CfgPatches
{
	class EUBG_NordicBG_Weapons
	{
		units[] = {};
		weapons[] = {"EUBG_NordicBG_AK5C_F","EUBG_NordicBG_AK5C","EUBG_NordicBG_AK5D_F","EUBG_NordicBG_AK5D","EUBG_NordicBG_AK5C_M203_F","EUBG_NordicBG_AK5C_M203","EUBG_NordicBG_Ksp58","EUBG_NordicBG_Ksp90","EUBG_NordicBG_Psg90","EUBG_NordicBG_AG90","EUBG_NordicBG_Pist88","EUBG_NordicBG_RK62","EUBG_NordicBG_RK62_M203","EUBG_NordicBG_Steyr","EUBG_NordicBG_Steyr_M203","EUBG_NordicBG_G36","EUBG_NordicBG_G38_M203","EUBG_NordicBG_Glock17","EUBG_NordicBG_FNMAG","EUBG_NordicBG_FNMinimi","EUBG_NordicBG_AWM","EUBG_NordicBG_M107"};
		requiredVersion = 0.1;
		requiredAddons[] = {};
	};
};
class CfgWeapons
{
	...
	class EUBG_NordicBG_AK5C_F: arifle_MX_Black_F
	{
		...
		hiddenselectionstextures[] = {"\EUBG_Main\Weapons\data\AK5C_base_co.paa","\EUBG_Main\Weapons\data\AK5D_base_co.paa"};
	};
	...
	class EUBG_NordicBG_AK5D_F: arifle_MXC_Black_F
	{
		...
		hiddenselectionstextures[] = {"\EUBG_Main\Weapons\data\AK5D_base_co.paa"};
	};
	...
	class EUBG_NordicBG_AK5C_M203_F: arifle_MX_GL_Black_F
	{
		...
		hiddenselections[] = {"camo1","camo2"};
		hiddenselectionstextures[] = {"\EUBG_Main\Weapons\data\AK5C_base_co.paa","\EUBG_Main\Weapons\data\glx_black_co.paa"};
	};
