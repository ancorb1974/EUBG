...
class CfgVehicles
{
	...
	class EUBG_Nordic_S_XA203: O_APC_Wheeled_02_rcws_F
	{
		dlc="NordicBG";
		author = "OldDutchGamer";
		scope = 2;
		displayName = "Pansarterrängbil 203";
		side = 1;
		...
		hiddenSelectionsTextures[] = {"\EUBG_NordicBG\Vehicles\Wheeled\PatriPasi\XA203_body_S_co.paa", "\EUBG_NordicBG\Vehicles\Wheeled\PatriPasi\XA203_wheels_S_co.paa", "\EUBG_NordicBG\Vehicles\Wheeled\PatriPasi\XA203_turret_S_co.paa"};
	...
	class EUBG_Nordic_S_RG32: B_MRAP_01_F
	{
		...
		hiddenSelections[] = {"Camo1", "Camo2","Camo3"};
		hiddenSelectionsTextures[] = {"\EUBG_NordicBG\Vehicles\Wheeled\RG32\rg32_body_S_co.paa", "\EUBG_NordicBG\Vehicles\Wheeled\RG32\rg32_wheels_S_co.paa", "\EUBG_NordicBG\Vehicles\Wheeled\PatriPasi\XA203_turret_S_co.paa"};
